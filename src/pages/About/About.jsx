...
const About = () => {
  return (
    <div className="flex justify-center items-center md:px-40">
      <div className="bg-white w-full mt-16 mb-16 py-6 hover:shadow-box-shadow ">
        <div className="flex flex-col items-center justify-center mt-0 py-2 px-14">
          <div>
            <img src={profile} alt="" className="w-44 h-44 rounded-full" />
          </div>
          <h1 className="text-center text-3xl md:text-5xl mt-6 mb-1">
            Ruhul Amin
          </h1>
          ...
          <h3 className="text-xl break-words text-center">
            Innovative and passionate front-end developer with strong
          ...
          <div>
            <a
              ...
              {" "}
              <button className="btn my-4 border border-gray-950 rounded-none">
                Download CV
              </button>
            </a>
          </div>
          <h1 className="text-2xl font-bold my-4">My Skills</h1>
